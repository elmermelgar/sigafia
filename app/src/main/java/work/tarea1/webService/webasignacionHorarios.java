...
public class webasignacionHorarios extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_webasignacion_horarios);
    ...
    public void WebConsultaAct(View view) {
        ...
        hola.execute("http://grupo16pdm16.netne.net/ws_resumenHorarioAsignacion.php?ID="+editText2.getText().toString());
    }
