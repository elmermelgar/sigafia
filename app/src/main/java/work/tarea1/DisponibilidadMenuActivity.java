...
public class DisponibilidadMenuActivity extends ListActivity {
    String[] menu={"Insertar Registro","Eliminar Registro","Consultar Registro",
            "Actualizar Registro"};
    String[] activities={"DisponibilidadCicloInsertarActivity","DisponibilidadCicloEliminarActivity","DisponibilidadCicloConsultarActivity","DisponibilidadCicloActualizarActivity"};
